  ...
  return (
    <div>
      ...
      <div className="rounded-lg bg-[#282828] border border-[#ffffff1a] p-6">
        <h2 className="mb-1 text-[18px] font-semibold text-white">Create Account</h2>
        <p className="mb-5 text-[13px] text-[#eff1f67a]">
          Join CodeJudge and start coding
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-[12px] font-medium text-[#eff1f6bf]">Username</label>
            <input
              type="text"
              placeholder="johndoe"
              value={username}
