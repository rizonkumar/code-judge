...
export { default as NotFoundError } from "./not_found.error";
...
export { default as BadGatewayError } from "./bad_gateway.error";
export { default as NotImplementedError } from "./notImplemented.error";
